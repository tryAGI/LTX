<div class="docs-hero">
  <h1>LTX</h1>
  <p class="docs-hero-lead">Modern .NET SDK for LTX generated from the provider's OpenAPI definition with AutoSDK.</p>
  <div class="docs-badge-row">
    <a href="https://www.nuget.org/packages/LTX/"><img alt="Nuget package" src="https://img.shields.io/nuget/vpre/LTX"></a>
    <a href="https://github.com/tryAGI/LTX/actions/workflows/dotnet.yml"><img alt="dotnet" src="https://github.com/tryAGI/LTX/actions/workflows/dotnet.yml/badge.svg?branch=main"></a>
    <a href="https://github.com/tryAGI/LTX/blob/main/LICENSE.txt"><img alt="License: MIT" src="https://img.shields.io/github/license/tryAGI/LTX"></a>
...
<div class="docs-feature-grid">
  <div class="docs-feature-card">
    ...
    <p>Built from <a href="https://example.com/ltx-openapi.yaml">LTX's OpenAPI definition</a> so the SDK stays close to the upstream API surface.</p>
  </div>
  <div class="docs-feature-card">
    <h3>Auto-updated</h3>
...
<div class="docs-card-grid">
  <div class="docs-card">
    <h3>Bugs</h3>
    <p>Open an issue in <a href="https://github.com/tryAGI/LTX/issues">tryAGI/LTX</a>.</p>
  </div>
  <div class="docs-card">
    <h3>Ideas and questions</h3>
    <p>Use <a href="https://github.com/tryAGI/LTX/discussions">GitHub Discussions</a> for design questions and usage help.</p>
  </div>
  <div class="docs-card">
    <h3>Community</h3>
