...
{
    private const string UserSecretsId = "LTX.CLI";
    private const string UserSecretApiKeyName = "LTX_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"LTX_API_KEY"];
    private const string CredentialFileDirectoryName = ".ltx";

    public static async global::System.Threading.Tasks.Task<global::LTX.LtxClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::LTX.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::LTX.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::LTX.LtxClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::LTX.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::LTX.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::LTX.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::LTX.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("LTX_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::LTX.ApiException exception)
    {
        var builder = new StringBuilder();
