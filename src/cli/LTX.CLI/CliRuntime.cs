...
internal static class CliRuntime
{
    ...
    public static async Task<global::LTX.LtxClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::LTX.ApiException exception)
    {
        var builder = new StringBuilder();
